<?php
		...
		$dibu='<img src="alumnos/00001.png" width="100" height="100">';
		...
		if(!empty($_GET['doc'])){
			...
			if($row=mysql_fetch_array($sql)){
				...
				if (file_exists("alumnos/Default.png".$nit.".jpg")){
					$dibu='<img src="alumnos/Default.png'.$nit.'.jpg" width="100" height="100" class="img-circle img-polaroid">';
				}else{
					$dibu='<img src="alumnos/00001.png" width="100" height="100">';
				}
                ...
                <td>
                	...
                	<div class="row-fluid">
                        ...
                        <div class="span6">
                            ...
                            <strong>Telefono Fijo / Celular</strong><br>
